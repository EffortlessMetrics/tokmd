...
mod tests {
    ...
    fn skips_dot_claude_prefix_paths() {
        ...
        let violation = evaluate_candidate(dir.path(), ".claude/config/key.pem").expect("check");
    ...
    fn skips_dot_jules_prefix_paths() {
        ...
        let violation = evaluate_candidate(dir.path(), ".jules/state/fixture.der").expect("check");
