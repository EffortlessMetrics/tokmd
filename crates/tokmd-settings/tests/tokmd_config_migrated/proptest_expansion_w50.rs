//! Property-based tests for tokmd-settings (W50 expansion).
//!
...
fn arb_profile() -> impl Strategy<Value = Profile> {
    (
        ...
        prop::option::of(prop_oneof![
            Just(tokmd_settings::CliRedactMode::None),
            Just(tokmd_settings::CliRedactMode::Paths),
            Just(tokmd_settings::CliRedactMode::All),
        ]),
        prop::option::of(any::<bool>()),
        prop::option::of(prop_oneof![
