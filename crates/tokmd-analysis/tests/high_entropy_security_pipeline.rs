...
#[test]
fn security_preset_detects_high_entropy_fixture() {
    ...
    let fixture = include_bytes!("fixtures/high_entropy.bin");
    fs::write(&output_path, fixture).expect("fixture bytes should be written");
