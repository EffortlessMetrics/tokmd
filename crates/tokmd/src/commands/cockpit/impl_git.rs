...
pub(crate) fn handle_inner(args: cli::CockpitArgs, _global: &cli::GlobalArgs) -> Result<()> {
...
pub(crate) fn write_artifacts(dir: &Path, receipt: &CockpitReceipt) -> Result<()> {
...
pub(crate) fn write_sensor_artifacts(
    dir: &Path,
