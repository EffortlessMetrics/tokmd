...
#[derive(Default)]
pub(in crate::commands::handoff::output) struct LinkedEvidenceSummary {
...
pub(in crate::commands::handoff::output) struct ReviewMapSummary {
    item_count: usize,
...
pub(in crate::commands::handoff::output) struct ReviewMapItemSummary {
    path: String,
    reason: Option<String>,
}

pub(in crate::commands::handoff::output) struct ReviewPacketCheckSummary {
    ok: Option<bool>,
    artifact_count: Option<u64>,
    hashes_verified: Option<u64>,
}

pub(in crate::commands::handoff::output) struct AffectedSummary {
    changed_files: usize,
    scopes: usize,
    unknown_files: usize,
...
pub(in crate::commands::handoff::output) struct ProofPlanSummary {
    commands: usize,
    required: usize,
    advisory: usize,
...
pub(in crate::commands::handoff::output) fn render_linked_evidence_summary(
    out: &mut String,
...
pub(in crate::commands::handoff::output) fn summarize_linked_evidence(
    links: &HandoffLinkInputs<'_>,
