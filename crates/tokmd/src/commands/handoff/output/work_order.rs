...
use super::evidence::{LinkedEvidenceSummary, summarize_linked_evidence};
use super::links::{HandoffLinkInputs, has_any_link, path_string};

pub(crate) struct HandoffWorkOrderInputs<'a> {
    ...
    pub(crate) rank_by: &'a str,
    pub(crate) intelligence_preset: &'a str,
    pub(crate) total_files: usize,
    pub(crate) selected: &'a [ContextFileRow],
    pub(crate) links: &'a HandoffLinkInputs<'a>,
}
