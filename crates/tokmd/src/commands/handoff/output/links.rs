//! Handoff external-link artifact descriptors.
...
pub(crate) struct HandoffLinkInputs<'a> {
    pub(crate) review_packet_dir: Option<&'a Path>,
    pub(crate) review_packet_check: Option<&'a Path>,
    pub(crate) affected: Option<&'a Path>,
    pub(crate) proof_plan: Option<&'a Path>,
}
...
pub(super) fn has_any_link(links: &HandoffLinkInputs<'_>) -> bool {
