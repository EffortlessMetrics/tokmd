//! External handoff evidence link artifact writers.
...
use super::artifacts::write_json_artifact;
use super::path_string;

pub(in crate::commands::handoff) struct HandoffLinkInputs<'a> {
    pub(in crate::commands::handoff) review_packet_dir: Option<&'a Path>,
    pub(in crate::commands::handoff) review_packet_check: Option<&'a Path>,
    pub(in crate::commands::handoff) affected: Option<&'a Path>,
    pub(in crate::commands::handoff) proof_plan: Option<&'a Path>,
}

pub(in crate::commands::handoff) fn write_link_artifacts(
    out_dir: &Path,
