...
/// The JSON schema content (inlined to ensure test portability across build environments like Nix)
const SCHEMA_CONTENT: &str = r##"{
  "$schema": "http://json-schema.org/draft-07/schema#",
  "title": "Tokmd Receipt",
  "description": "Output schema for tokmd (language, module, export, and analysis reports). Schema version 4.",
  "oneOf": [
