...
Pull requests run advisory `ripr` evidence, impacted evidence, fast gates, docs checks, publish preflight, example smoke checks, and targeted mutation when routing rules require it.
