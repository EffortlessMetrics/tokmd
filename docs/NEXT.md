...
- Next proof-policy operational slice: decide whether the manual observation collector should emit a first-class promotion-readiness receipt that verifies `min_passing_collector_runs` from GitHub run history.
