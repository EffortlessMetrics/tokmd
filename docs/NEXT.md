...
- Next proof-policy operational slice: collect successful non-required executor runs across multiple coverage-enabled affected scopes before considering any required-gate or default Codecov-upload promotion.
