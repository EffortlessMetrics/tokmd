...
- Next proof-policy operational slice: dispatch the policy-default collector again after this receipt lands and record the resulting promotion-readiness artifact evidence before considering required-gate or default Codecov-upload promotion.
